...
//                int eY = sY + cellSize;
                ...
                if (currCell != null) {
                    ...
                    ImageView iv = findViewById(R.id.cell1);
                    iv.setImageDrawable(getResources().getDrawable(cellIds[index]));
                }
            }
        }
    }
...
//                    ArrayList<AnimationCell> aArray = game.grid.getCellContent(xx, yy);
...
//                            int dX = (int) ((currentX) * (cellSize + gridWidth) * (percentDone - 1) * 1.0);
//                            int dY = (int) ((currentY) * (cellSize + gridWidth) * (percentDone - 1) * 1.0);

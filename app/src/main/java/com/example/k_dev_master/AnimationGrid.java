...
public class AnimationGrid {
    ...
    public void startAnimation(int x, int y, int value, int animationType, long length, long delay, int[] extras) {
        AnimationCell animationToAdd = new AnimationCell(x, y, value, animationType, length, delay, extras);
        if (x == -1 && y == -1) {
